...
#optimizer = Optimizer_RMSProp(decay = 1e-1)
#optimizer = Optimizer_RMSProp(decay = 1e-4)
#optimizer = Optimizer_RMSProp(learning_rate = 0.02, decay = 1e-4, rho = 0.95)
optimizer = Optimizer_RMSProp(learning_rate = 0.005, decay = 1e-5, rho = 0.9)
